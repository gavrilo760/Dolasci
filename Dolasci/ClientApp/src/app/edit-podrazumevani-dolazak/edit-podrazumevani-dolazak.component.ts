...
@Component({
  selector: 'app-edit-podrazumevani-dolazak',
  templateUrl: './edit-podrazumevani-dolazak.component.html',
  styleUrls: ['./edit-podrazumevani-dolazak.component.css']
})
export class EditPodrazumevaniDolazakComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.servis.getPodrazumevaniById(this.i).subscribe(data => {
      this.dolazak = data;
